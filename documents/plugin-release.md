...
- Codex registered that fresh GitHub repository but could not discover the plugin until `.agents/plugins/marketplace.json` was added. With the new catalog, local candidate install/remove/reinstall succeeded at 2.0.0. Recheck from a fresh clone of the final candidate commit after it is pushed.
